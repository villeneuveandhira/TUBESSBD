                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">List Program yang Tersedia</h6>
                        </div>
                        <div class="card-body">
                        <?php
                                ...
                                echo '<div class="table-responsive">';
                                    echo '<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">';
                                        echo "<thead>";
                                            echo "<tr>";
                                                echo "<th>No.</th>";
                                                echo "<th>ID Program</th>";
                                                echo "<th>Nama Program</th>";
                                                echo "<th>Jenis Program</th>";
                                                echo "<th>Durasi</th>";
                                                echo "<th>SKS Program</th>";
                                                echo "<th>Lingkup Program</th>";
                                                echo "<th>Aksi</th>";
                                            echo "</tr>";
                                        echo "</thead>";
                                        echo "<tbody>";
