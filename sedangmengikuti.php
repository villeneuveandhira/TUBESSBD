...
if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
    ...
    $sql = "SELECT * FROM kontrakmbkm WHERE nim = ? AND status = 'sedang mengikuti' AND semester_kontrak = ?";
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            if(mysqli_num_rows($result) == 1){
                ...
                $status = $row["status"];
                $nip_pembimbingmbkm = $row["nip_pembimbingmbkm"];
            } else{
                echo "Oops! Something went wrong. Please try again later.";
            }
        } else{
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid text-center">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Anda sedang mengikuti sebuah program MBKM</h1>
                    ...
                    <p>Selamat menjalankan program MBKM</p>
                    <p>Sudah selesai menjalankan program MBKM? Klik <a href='prosesselesai.php?id=<?= $id; ?>'>disini</a></p>
                </div>
